...
Ke depan, perusahaan disarankan untuk melakukan langkah-langkah strategis seperti:
  1. Fokus pada channel dan kategori yang profitable: Mengalokasikan lebih banyak sumber daya pada channel Fashionista, kategori EMI Payments, dan sektor Retail yang telah terbukti memberikan kontribusi positif.
  2. Mengurangi kerugian pada channel atau sektor yang underperforming: Mengkaji ulang strategi untuk channel seperti ZenGrocery atau bahkan mempertimbangkan penghentian operasinya jika terus merugi tanpa potensi perbaikan.
  3. Adaptasi terhadap perubahan pasar: Memanfaatkan peluang di pasar digital atau meningkatkan efisiensi operasional agar lebih kompetitif di era pasca-pandemi.
  4. Diversifikasi risiko: Mengembangkan produk atau layanan baru yang dapat menopang stabilitas perusahaan di masa depan.
